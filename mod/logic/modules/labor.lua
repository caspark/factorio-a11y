...
local function render_task_queue_and_pool_ui(player)
...
function M.render_ui(player)
    render_task_queue_and_pool_ui(player)
    ...
    -- get a reference to the UI, remove any existing drawings, then save new drawings in it
